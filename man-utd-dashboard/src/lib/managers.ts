...
export const MANAGERS: ManagerStint[] = [
  ...
  { id: 'carrick-2021', name: 'Michael Carrick', nameTh: 'ไมเคิล คาร์ริค', from: '2021-11-22', to: '2021-12-02', interim: true },
  ...
  { id: 'amorim', name: 'Ruben Amorim', nameTh: 'รูเบน อาโมริม', from: '2024-11-11', to: '2026-01-05', interim: false },
  { id: 'fletcher', name: 'Darren Fletcher', nameTh: 'ดาร์เรน เฟลทเชอร์', from: '2026-01-06', to: '2026-01-13', interim: true },
  { id: 'carrick-2026', name: 'Michael Carrick', nameTh: 'ไมเคิล คาร์ริค', from: '2026-01-14', to: null, interim: false },
];
